    ...
    <div class="row justify-content-center">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-block bg-login-image" style="background-image: url({{ asset('img/dclogo.png') }})"></div>
                    <div class="col-lg-6 login-form-container">
                        <div class="p-5">
                            <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Welcome Back!</h1>
                            @if (session('authenticate_message'))
                                <div class="alert alert-warning">
                                    {{ session('authenticate_message') }}
                                </div>
                            @endif
                            </div>
